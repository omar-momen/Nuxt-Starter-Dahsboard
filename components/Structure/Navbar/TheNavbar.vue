<template>
  <nav
    class="shadow-lg rounded-xl bg-whiteColor fixed z-[998] end-[var(--sidebar-navbar-x-margin)] top-[var(--navbar-top-margin)] lg:mx-auto h-[var(--navbar-height)] lg:transition-all lg:duration-[800ms]"
